...
- Related asset tracking roadmap is documented:
  ...
  - `entity_seed_definitions` is implemented as the DB-backed reviewed seed registry with Alembic revision `20260501_0008`.
  ...
  - Next follow-up should run and review the S&P 500 import locally, then decide whether to export a reviewed snapshot artifact into the repo.
