...
class OllamaSentimentProvider:
    ...
    def _user_prompt(self, *, article_text: str, ticker: str) -> str:
        return (
            ...
            "unless it is supported by an evidence snippet; label an article mixed when "
            "material positive signals and material negative signals both appear, even if "
            "one side is stronger; do not label an article negative when positive evidence "
            "such as strong demand, backlog, upside, adoption, growth, or improved results "
            "materially offsets the risks. Label an article neutral when it only reports "
            "routine operations, product events, conference schedules, launches, or product "
            "availability without financial results, demand evidence, guidance, analyst action, "
            "valuation evidence, or risk language. Do not treat a product event or launch as "
            "positive unless the article connects it to demand, revenue, adoption, margins, "
            "market share, or guidance. Only use driver categories from this exact set: "
            "earnings, guidance, demand, regulatory, valuation, macro, analyst_action, "
            "product, supply, uncertainty. Map backlog and order trends to demand; do not "
            "return backlog, operations, event, launch, or operational update as drivers. "
            "Use demand for demand, backlog, customer delays, or order trends. Use product "
            "for financially material product adoption, accelerator adoption, or platform "
            "uptake. Use valuation only for explicit "
            "valuation, multiple, price target, or upside/downside valuation language. "
            "Use analyst_action only for analyst upgrades, downgrades, initiations, or "
            "price target changes. Use uncertainty when the article "
