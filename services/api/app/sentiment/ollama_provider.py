...
class OllamaSentimentProvider:
    ...
    def _user_prompt(self, *, article_text: str, ticker: str) -> str:
        return (
            ...
            "materially offsets the risks. Use demand for demand, backlog, customer delays, "
            "or order trends. Use product for product adoption, accelerator adoption, "
            "platform uptake, or product launches. Use valuation only for explicit "
